...
Para clonar e executar este projeto, você precisará configurar o ambiente Firebase.
...
3.  **Configuração do Firebase:**
      ...
      * Crie um novo projeto Android com o `package_name`: `com.example.myapplication`.
      * Baixe o arquivo `google-services.json` gerado pelo Firebase.
      * Copie e cole o arquivo `google-services.json` no diretório `app/` do seu projeto.

4.  **Habilitar Serviços do Firebase:**

      * No console do Firebase, habilite os seguintes serviços:
          * **Authentication:** Vá para a aba "Authentication", clique em "Sign-in method" e habilite a opção "Email/Senha". (Crie um usuário admin, ex: `admin@admin.com` / `admin1234`).
...
6.  **Compile e Execute:**
      ...
      * O Android Studio irá sincronizar o Gradle. Após a sincronização, compile e execute o aplicativo em um emulador ou dispositivo físico.
